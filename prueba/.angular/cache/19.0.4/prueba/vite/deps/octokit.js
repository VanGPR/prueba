        ...
        trigger(name, ...args) {
          return __async(this, null, function* () {
            ...
            try {
              ...
              promises = this._events[name].map((listener) => __async(this, null, function* () {
                var e2, returned;
      ...
      Job = class Job {
        ...
        doExecute(chained, clearGlobalState, run, free) {
          return __async(this, null, function* () {
            ...
            try {
              passed = yield chained != null ? chained.schedule(this.options, this.task, ...this.args) : this.task(...this.args);
              if (clearGlobalState()) {
        ...
        _onFailure(error, eventInfo, clearGlobalState, run, free) {
          return __async(this, null, function* () {
            ...
            if (clearGlobalState()) {
              retry2 = yield this.Events.trigger("failed", error, eventInfo);
              if (retry2 != null) {
                retryAfter = ~~retry2;
        ...
        class Group2 {
          ...
          deleteKey(key = "") {
            return __async(this, null, function* () {
              ...
              if (this.connection) {
                deleted = yield this.connection.__runCommand__(["del", ...Scripts$1.allKeys(`${this.id}-${key}`)]);
              }
              if (instance != null) {
          ...
          clusterKeys() {
            return __async(this, null, function* () {
              ...
              while (cursor !== 0) {
                [next, found] = yield this.connection.__runCommand__(["scan", cursor != null ? cursor : 0, "match", `b_${this.id}-*_settings`, "count", 1e4]);
                cursor = ~~next;
          ...
          _startAutoCleanup() {
            ...
            return typeof (base = this.interval = setInterval(() => __async(this, null, function* () {
        ...
        class Bottleneck3 {
            ...
            return __async(this, null, function* () {
              ...
              try {
                ({
                  ...
                  blocked,
                  strategy
                } = yield this._store.__submit__(this.queued(), options.weight));
              } catch (error1) {
                error = error1;
          ...
          updateSettings() {
            return __async(this, arguments, function* (options = {}) {
              yield this._store.__updateSettings__(parser$5.overwrite(options, this.storeDefaults));
...
var createIterator = (octokit) => {
  return (query, initialParameters = {}) => {
    ...
    let parameters = __spreadValues({}, initialParameters);
    return {
      [Symbol.asyncIterator]: () => ({
        next() {
          return __async(this, null, function* () {
...
var createPaginate = (octokit) => {
  ...
  return (_0, ..._1) => __async(void 0, [_0, ..._1], function* (query, initialParameters = {}) {
    let mergedResponse = {};
    try {
      for (var iter = __forAwait(iterator2(query, initialParameters)), more, temp, error; more = !(temp = yield iter.next()).done; more = false) {
...
function errorRequest(state, octokit, error, options) {
  return __async(this, null, function* () {
...
function wrapRequest(state, octokit, request2, options) {
  return __async(this, null, function* () {
...
function requestWithGraphqlErrorHandling(state, octokit, request2, options) {
  return __async(this, null, function* () {
    const response = yield request2(request2, options);
...
function doRequest(state, request2, options) {
  return __async(this, null, function* () {
    ...
    if (isWrite || isGraphQL) {
      yield state.write.key(state.id).schedule(jobOptions, noop2);
    }
    if (isWrite && state.triggersNotification(pathname)) {
      yield state.notifications.key(state.id).schedule(jobOptions, noop2);
    }
    if (isSearch) {
      yield state.search.key(state.id).schedule(jobOptions, noop2);
    }
...
var createGroups = function(Bottleneck2, common) {
  groups.global = new Bottleneck2.Group(__spreadValues({
    id: "octokit-global",
    maxConcurrent: 10
  }, common));
  groups.search = new Bottleneck2.Group(__spreadValues({
    id: "octokit-search",
    maxConcurrent: 1,
    minTime: 2e3
  }, common));
  groups.write = new Bottleneck2.Group(__spreadValues({
    id: "octokit-write",
    maxConcurrent: 1,
    minTime: 1e3
  }, common));
  groups.notifications = new Bottleneck2.Group(__spreadValues({
...
function throttling(octokit, octokitOptions) {
  ...
  state.retryLimiter.on("failed", function(error, info) {
    return __async(this, null, function* () {
...
function oauthRequest(request2, route, parameters) {
  return __async(this, null, function* () {
    const withOAuthParameters = __spreadValues({
      baseUrl: requestToOAuthBaseUrl(request2),
      headers: {
        accept: "application/json"
      }
    }, parameters);
    const response = yield request2(route, withOAuthParameters);
...
function getWebFlowAuthorizationUrl(_a) {
  var _b = _a, {
  ...
  return oauthAuthorizationUrl(__spreadProps(__spreadValues({}, options), {
    baseUrl
  }));
}
function exchangeWebFlowCode(options) {
  return __async(this, null, function* () {
    const request2 = options.request || /* istanbul ignore next: we always pass a custom request in tests */
    request;
    const response = yield oauthRequest(request2, "POST /login/oauth/access_token", {
...
function createDeviceCode(options) {
  return __async(this, null, function* () {
    const request2 = options.request || /* istanbul ignore next: we always pass a custom request in tests */
    request;
    const parameters = {
...
function exchangeDeviceCode(options) {
  return __async(this, null, function* () {
    const request2 = options.request || /* istanbul ignore next: we always pass a custom request in tests */
    request;
    const response = yield oauthRequest(request2, "POST /login/oauth/access_token", {
...
function checkToken(options) {
  return __async(this, null, function* () {
    const request2 = options.request || /* istanbul ignore next: we always pass a custom request in tests */
    request;
    const response = yield request2("POST /applications/{client_id}/token", {
      headers: {
...
function scopeToken(options) {
  return __async(this, null, function* () {
    ...
    request;
    const response = yield request2("POST /applications/{client_id}/token/scoped", __spreadValues({
      headers: {
...
function resetToken(options) {
  return __async(this, null, function* () {
    ...
    const response = yield request2("PATCH /applications/{client_id}/token", {
      headers: {
...
function getOAuthAccessToken(state, options) {
  return __async(this, null, function* () {
...
function waitForAccessToken(request2, clientId, clientType, verification) {
  return __async(this, null, function* () {
    try {
      const options = {
        clientId,
      ...
      const {
        authentication
      } = clientType === "oauth-app" ? yield exchangeDeviceCode(__spreadProps(__spreadValues({}, options), {
        clientType: "oauth-app"
      })) : yield exchangeDeviceCode(__spreadProps(__spreadValues({}, options), {
        clientType: "github-app"
      }));
...
function auth2(state, authOptions) {
  return __async(this, null, function* () {
...
function hook2(state, request2, route, parameters) {
  return __async(this, null, function* () {
...
function createOAuthDeviceAuth(options) {
  ...
  const _a = options, {
    request: request2 = requestWithDefaults
  } = _a, otherOptions = __objRest(_a, [
    "request"
  ]);
...
function getAuthentication(state) {
  return __async(this, null, function* () {
    if ("code" in state.strategyOptions) {
      const {
        authentication
      } = yield exchangeWebFlowCode(__spreadProps(__spreadValues({
        clientId: state.clientId,
...
function hook3(_0, _1, _2) {
  return __async(this, arguments, function* (state, request2, route, parameters = {}) {
    const endpoint2 = request2.endpoint.merge(route, parameters);
    if (/\/login\/(oauth\/access_token|device\/code)$/.test(endpoint2.url)) {
      return request2(endpoint2);
    }
    ...
    const {
      token
    } = state.clientType === "oauth-app" ? yield auth3(__spreadProps(__spreadValues({}, state), {
      request: request2
    })) : yield auth3(__spreadProps(__spreadValues({}, state), {
      request: request2
    }));
    endpoint2.headers.authorization = "token " + token;
    return request2(endpoint2);
...
function createOAuthUserAuth(_a) {
  var _b = _a, {
    ...
    onTokenCreated
  } = _b, strategyOptions = __objRest(_b, [
    "clientId",
    "clientSecret",
    "clientType",
    "request",
...
function auth4(state, authOptions) {
  return __async(this, null, function* () {
    ...
    if ("factory" in authOptions) {
      const _a = __spreadValues(__spreadValues({}, authOptions), state), {
        type
    ...
    const common = __spreadValues({
      clientId: state.clientId,
      clientSecret: state.clientSecret,
      request: state.request
    }, authOptions);
    const userAuth = state.clientType === "oauth-app" ? yield createOAuthUserAuth(__spreadProps(__spreadValues({}, common), {
      clientType: state.clientType
    })) : yield createOAuthUserAuth(__spreadProps(__spreadValues({}, common), {
      clientType: state.clientType
    }));
    return userAuth();
  });
}
function hook4(state, request2, route, parameters) {
  return __async(this, null, function* () {
    let endpoint2 = request2.endpoint.merge(route, parameters);
    if (/\/login\/(oauth\/access_token|device\/code)$/.test(endpoint2.url)) {
      return request2(endpoint2);
    ...
    endpoint2.headers.authorization = `basic ${credentials}`;
    try {
      return yield request2(endpoint2);
    } catch (error) {
...
function getToken(_0) {
  return __async(this, arguments, function* ({
    ...
    const importedKey = yield subtle.importKey("pkcs8", privateKeyDER, algorithm, false, ["sign"]);
    const encodedMessage = getEncodedMessage(header, payload);
    const encodedMessageArrBuf = string2ArrayBuffer(encodedMessage);
    const signatureArrBuf = yield subtle.sign(algorithm.name, importedKey, encodedMessageArrBuf);
...
function getAppAuthentication(_0) {
  return __async(this, arguments, function* ({
    appId,
    privateKey,
    timeDifference
    ...
    try {
      ...
      const appAuthentication = yield githubAppJwt(authOptions);
      return {
        type: "app",
...
function set2(cache, options, data) {
  return __async(this, null, function* () {
...
function getInstallationAuthentication(state, options, customRequest) {
  return __async(this, null, function* () {
    ...
    if (options.factory) {
      const _a = __spreadValues(__spreadValues({}, state), options), {
        type,
        factory,
        oauthApp
      } = _a, factoryAuthOptions = __objRest(_a, [
        "type",
        "factory",
        "oauthApp"
      ]);
    ...
    if (!options.refresh) {
      const result = yield get2(state.cache, optionsWithInstallationTokenFromState);
      if (result) {
        const {
          token: token2,
    ...
    } = yield request2("POST /app/installations/{installation_id}/access_tokens", payload);
    ...
    yield set2(state.cache, optionsWithInstallationTokenFromState, cacheOptions);
    const cacheData = {
      installationId,
      token,
      createdAt,
...
function auth5(state, authOptions) {
  return __async(this, null, function* () {
...
var PATHS = ["/app", "/app/hook/config", "/app/hook/deliveries", "/app/hook/deliveries/{delivery_id}", "/app/hook/deliveries/{delivery_id}/attempts", "/app/installations", "/app/installations/{installation_id}", "/app/installations/{installation_id}/access_tokens", "/app/installations/{installation_id}/suspended", "/app/installation-requests", "/marketplace_listing/accounts/{account_id}", "/marketplace_listing/plan", "/marketplace_listing/plans", "/marketplace_listing/plans/{plan_id}/accounts", "/marketplace_listing/stubbed/accounts/{account_id}", "/marketplace_listing/stubbed/plan", "/marketplace_listing/stubbed/plans", "/marketplace_listing/stubbed/plans/{plan_id}/accounts", "/orgs/{org}/installation", "/repos/{owner}/{repo}/installation", "/users/{username}/installation"];
...
function hook5(state, request2, route, parameters) {
  return __async(this, null, function* () {
    const endpoint2 = request2.endpoint.merge(route, parameters);
    ...
    if (requiresAppAuth(url.replace(request2.endpoint.DEFAULTS.baseUrl, ""))) {
      ...
      let response;
      try {
        response = yield request2(endpoint2);
      } catch (error) {
        ...
        const {
          token: token3
        } = yield getAppAuthentication(__spreadProps(__spreadValues({}, state), {
          timeDifference: diff
        }));
    ...
    const {
      token,
      createdAt
    } = yield getInstallationAuthentication(
      state,
      // @ts-expect-error TBD
      {},
      request2.defaults({
...
function sendRequestWithRetries(state, request2, options, createdAt, retries = 0) {
  return __async(this, null, function* () {
    const timeSinceTokenCreationInMs = +/* @__PURE__ */ new Date() - +new Date(createdAt);
    try {
      return yield request2(options);
    } catch (error) {
      if (error.status !== 401) {
        throw error;
      }
...
function hook6(reason, request2, route, parameters) {
  return __async(this, null, function* () {
    const endpoint2 = request2.endpoint.merge(route, parameters);
...
function emitEvent(state, context) {
  return __async(this, null, function* () {
    const {
      name,
      action
...
function getUserOctokitWithState(state, options) {
  return __async(this, null, function* () {
    return state.octokit.auth(__spreadProps(__spreadValues({
      type: "oauth-user"
    }, options), {
      factory(options2) {
        return __async(this, null, function* () {
...
function getWebFlowAuthorizationUrlWithState(state, options) {
  ...
  return getWebFlowAuthorizationUrl(__spreadValues({
    clientType: state.clientType
  }, optionsWithDefaults));
}
function createTokenWithState(state, options) {
  return __async(this, null, function* () {
    const authentication = yield state.octokit.auth(__spreadValues({
      type: "oauth-user"
    }, options));
    yield emitEvent(state, {
      name: "token",
...
function checkTokenWithState(state, options) {
  return __async(this, null, function* () {
    const result = yield checkToken(__spreadValues({
...
function resetTokenWithState(state, options) {
  return __async(this, null, function* () {
    ...
    if (state.clientType === "oauth-app") {
      const response2 = yield resetToken(__spreadValues({
        clientType: "oauth-app"
      }, optionsWithDefaults));
    ...
    const response = yield resetToken(__spreadValues({
      clientType: "github-app"
    }, optionsWithDefaults));
...
function scopeTokenWithState(state, options) {
  return __async(this, null, function* () {
    if (state.clientType === "oauth-app") {
      throw new Error("[@octokit/oauth-app] app.scopeToken() is not supported for OAuth Apps");
    }
    const response = yield scopeToken(__spreadValues({
      clientType: "github-app",
      clientId: state.clientId,
      clientSecret: state.clientSecret,
      request: state.octokit.request
...
function deleteTokenWithState(state, options) {
  return __async(this, null, function* () {
    const optionsWithDefaults = __spreadValues({
      clientId: state.clientId,
      clientSecret: state.clientSecret,
    ...
    const response = state.clientType === "oauth-app" ? yield deleteToken(__spreadValues({
      clientType: "oauth-app"
    }, optionsWithDefaults)) : (
      // istanbul ignore next
      yield deleteToken(__spreadValues({
        clientType: "github-app"
      }, optionsWithDefaults))
    );
    yield emitEvent(state, {
...
function deleteAuthorizationWithState(state, options) {
  return __async(this, null, function* () {
    const optionsWithDefaults = __spreadValues({
      clientId: state.clientId,
      clientSecret: state.clientSecret,
    ...
    const response = state.clientType === "oauth-app" ? yield deleteAuthorization(__spreadValues({
      clientType: "oauth-app"
    }, optionsWithDefaults)) : (
      // istanbul ignore next
      yield deleteAuthorization(__spreadValues({
        clientType: "github-app"
      }, optionsWithDefaults))
    );
    yield emitEvent(state, {
...
function handleRequest(_0, _1, _2) {
  return __async(this, arguments, function* (app, {
    ...
    let json;
    try {
      const text = yield request2.text();
...
function createNodeMiddleware(app, options = {}) {
  return function(request2, response, next) {
    return __async(this, null, function* () {
      const octokitRequest = yield parseRequest(request2);
...
var OAuthApp = class {
  ...
  static defaults(defaults) {
    const OAuthAppWithDefaults = class extends this {
      constructor(...args) {
        super(__spreadValues(__spreadValues({}, defaults), args[0]));
      }
    };
...
function sign(secret, payload) {
  return __async(this, null, function* () {
    ...
    const signature = yield crypto.subtle.sign("HMAC", yield importKey(secret), enc.encode(payload));
...
function verify(secret, eventPayload, signature) {
  return __async(this, null, function* () {
    ...
    const algorithm = "sha256";
    return yield crypto.subtle.verify("HMAC", yield importKey(secret), hexToUInt8Array(signature.replace(`${algorithm}=`, "")), enc.encode(eventPayload));
  });
}

// node_modules/@octokit/webhooks/dist-bundle/index.js
var createLogger = (logger) => __spreadValues({
  debug: () => {
  },
  info: () => {
  },
...
function verifyAndReceive(state, event) {
  return __async(this, null, function* () {
    const matchesSignature = yield verify(state.secret, event.payload, event.signature).catch(() => false);
    if (!matchesSignature) {
...
function getPayload(request2) {
  ...
  return new Promise((resolve, reject) => {
    let data = [];
    request2.on("error", (error) => reject(new AggregateError([error], error.message)));
...
function middleware(webhooks2, options, request2, response, next) {
  return __async(this, null, function* () {
    let pathname;
    try {
    ...
    try {
      const payload = yield getPayload(request2);
      yield webhooks2.verifyAndReceive({
        id,
        name: eventName,
        payload,
...
var VERSION14 = "15.1.1";
function webhooks(appOctokit, options) {
  return new Webhooks({
    secret: options.secret,
    transform: (event) => __async(this, null, function* () {
      ...
      const octokit = yield appOctokit.auth({
        ...
        installationId,
        factory(auth7) {
          return new auth7.octokit.constructor(__spreadValues(__spreadProps(__spreadValues({}, auth7.octokitOptions), {
            authStrategy: createAppAuth
          }), {
            auth: __spreadProps(__spreadValues({}, auth7), {
              installationId
            })
          }));
        }
...
function getInstallationOctokit(app, installationId) {
  return __async(this, null, function* () {
    return app.octokit.auth({
      type: "installation",
      installationId,
      factory(auth7) {
        const options = __spreadValues(__spreadProps(__spreadValues({}, auth7.octokitOptions), {
          authStrategy: createAppAuth
        }), {
          auth: __spreadProps(__spreadValues({}, auth7), {
            installationId
  ...
  return {
    [Symbol.asyncIterator]() {
      return __asyncGenerator(this, null, function* () {
        ...
        try {
          for (var iter = __forAwait(iterator2), more, temp, error; more = !(temp = yield new __await(iter.next())).done; more = false) {
            const {
              data: installations
            } = temp.value;
            for (const installation of installations) {
              const installationOctokit = yield new __await(getInstallationOctokit(app, installation.id));
              yield {
...
function eachRepository(app, queryOrCallback, callback) {
  return __async(this, null, function* () {
...
function singleInstallationIterator(app, installationId) {
  return {
    [Symbol.asyncIterator]() {
      return __asyncGenerator(this, null, function* () {
        yield {
          octokit: yield new __await(app.getInstallationOctokit(installationId))
        };
      });
    }
  };
  ...
  return {
    [Symbol.asyncIterator]() {
      return __asyncGenerator(this, null, function* () {
        ...
        try {
          for (var iter2 = __forAwait(iterator2), more2, temp2, error2; more2 = !(temp2 = yield new __await(iter2.next())).done; more2 = false) {
            const {
              octokit
            } = temp2.value;
            const repositoriesIterator = composePaginateRest.iterator(octokit, "GET /installation/repositories");
            try {
              for (var iter = __forAwait(repositoriesIterator), more, temp, error; more = !(temp = yield new __await(iter.next())).done; more = false) {
                const {
                  data: repositories
                } = temp.value;
...
function getInstallationUrlFactory(app) {
  ...
  return function getInstallationUrl() {
    return __async(this, arguments, function* (options = {}) {
      ...
      const installationUrlBase = yield installationUrlBasePromise;
...
function getInstallationUrlBase(app) {
  return __async(this, null, function* () {
    const {
      data: appInfo
    } = yield app.octokit.request("GET /app");
    if (!appInfo) {
...
function createNodeMiddleware3(app, options = {}) {
  ...
  return middleware2.bind(null, optionsWithDefaults.pathPrefix, webhooksMiddleware, oauthMiddleware);
}
function middleware2(pathPrefix, webhooksMiddleware, oauthMiddleware, request2, response, next) {
  return __async(this, null, function* () {
    const {
      pathname
    } = new URL(request2.url, "http://localhost");
...
var App = class {
  ...
  constructor(options) {
    ...
    if (options.oauth) {
      this.oauth = new OAuthApp(__spreadProps(__spreadValues({}, options.oauth), {
        clientType: "github-app",
        Octokit: Octokit3
      }));
    } else {
...
var App2 = App.defaults({
  Octokit: Octokit2
});
var OAuthApp2 = OAuthApp.defaults({
  Octokit: Octokit2
});
export {
  App2 as App,
  OAuthApp2 as OAuthApp,
  Octokit2 as Octokit,
  RequestError,
  createNodeMiddleware3 as createNodeMiddleware
};
